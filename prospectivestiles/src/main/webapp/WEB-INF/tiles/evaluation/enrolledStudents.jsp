...
<h1>Enrolled Prospective Students</h1>

<h4>Total Enrolled: <c:out value="${enrolledCount}"></c:out></h4>
...
<div class="table-responsive">
	<table class="table table-hover table-striped">
		...
		<c:forEach var="userEntity" items="${enrolledUsers}">
			...
			<tr>
				...
				<td>
					<fmt:formatDate var="dateAdmittedString" value="${userEntity.dateEnrolled}" pattern="MM-dd-yyyy" />
