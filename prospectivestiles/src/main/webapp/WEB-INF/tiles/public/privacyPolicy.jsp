...
<div class="page-header">
	<h1>Privacy Policy for American College of Commerce and
	Technology</h1>
</div>
...
<!-- Source: https://www.freeprivacypolicy.com/manager.htm -->
<div style="font-family: arial">
	...
	phone number, credit card information or social security number. You
	may, however, visit our site anonymously.<br />
	<br />
	<strong>What do we use your information for?</strong> <br />
	<br />Any of the information we collect from you may be used in one of
	the following ways: <br />
	<br />; To improve our website<br />(we continually strive to improve
	our website offerings based on the information and feedback we receive
	from you)<br />
	...
	<blockquote>The email address you provide for order
		...
		updates, related product or service information, etc.</blockquote>
	<br />
	<br />
	<strong>How do we protect your information?</strong> <br />
	<br />We implement a variety of security measures to maintain the
	safety of your personal information when you enter, submit, or access
	your personal information. <br /> <br />We offer the use of a secure
	...
	<br />After a transaction, your private information (credit cards,
	social security numbers, financials, etc.) will be kept on file for
	more than 60 days in order to .<br />
	<br />
	...
	<br /> We use cookies to help us remember and process the items in
	your shopping cart.<br />
	<br />If you prefer, you can choose to have your computer warn you
	each time a cookie is being sent, or you can choose to turn off all
	cookies via your browser settings. Like most websites, if you turn your
	cookies off, some of our services may not function properly. However,
	you can still place orders over the telephone.<br />
	<br />
	...
	<br />This online privacy policy applies only to information collected
	through our website and not to information collected offline.<br />
	<br />
	<strong>Terms and Conditions</strong> <br />
	<br />Please also visit our Terms and Conditions section establishing
	the use, disclaimers, and limitations of liability governing the use of
	our website at <a href="www.acct2day.org/terms-and-conditions">www.acct2day.org/terms-and-conditions</a><br />
	<br />
	<strong>Your Consent</strong> <br />
	<br />By using our site, you consent to our <a
		style='text-decoration: none; color: #3C3C3C;'
		href='http://www.freeprivacypolicy.com/' target='_blank'>web site
		privacy policy</a>.<br />
	<br />
	...
	<span></span><span></span>This policy is powered by Trust Guard <a
		...
		target='_blank'>PCI compliance</a>.<span></span><span></span><span></span>
